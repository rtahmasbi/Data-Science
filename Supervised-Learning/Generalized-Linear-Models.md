...
Suppose that for a known matrix <img src="http://latex.codecogs.com/gif.latex?A"/>  <a src="http://latex.codecogs.com/gif.latex?A"/>  and vector <img src="http://latex.codecogs.com/gif.latex?\mathbf{b}"/>, we wish to find a vector $\mathbf {x}$  such that:
\[A\mathbf {x} =\mathbf {b}\]
